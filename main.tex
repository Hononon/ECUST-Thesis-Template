...
%反复交替运行，显示文献及编号：XeLaTeX+BibTeX+XeLaTeX
...
\documentclass[twoside,master,openany]{ecust_thesis}
...
% 使用 amsthm 的 proof 机制，支持在行间公式末尾通过 \qedhere 放置“证毕”
\renewcommand{\proofname}{\songtibold{证明}}
\renewcommand{\qedsymbol}{\mbox{\songtibold{证毕}}}
\makeatletter
...
%\vspace{10cm} % 或你想要的具体高度，如 2cm、20pt 等
\title{论文题目（中文）}
\englishtitle{
  \begin{tabular}{c}
...
% 根据博士/硕士选择对应的学位论文扉页_提交要求_授权声明_作者声明
\makeatletter
\ifECUST@doctor
  % 博士论文
  \includepdf[pages=-]{chapters/博士_学位论文扉页 提交要求 授权声明 作者声明.pdf}
\else
  % 硕士论文
  \includepdf[pages=-]{chapters/学位论文扉页_提交要求_授权声明_作者声明.pdf}
\fi
\makeatother
